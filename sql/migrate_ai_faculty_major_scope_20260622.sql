...
SET @has_user_title_ai_scope := (
    SELECT COUNT(*) FROM information_schema.COLUMNS
    WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'users' AND COLUMN_NAME = 'title'
);
SET @add_user_title_ai_scope_sql := IF(
    @has_user_title_ai_scope = 0,
    'ALTER TABLE users ADD COLUMN title VARCHAR(50) DEFAULT NULL COMMENT ''身份/职称，如教授、副教授、系主任、学生'' AFTER real_name',
    'SELECT 1'
);
PREPARE add_user_title_ai_scope_stmt FROM @add_user_title_ai_scope_sql;
EXECUTE add_user_title_ai_scope_stmt;
DEALLOCATE PREPARE add_user_title_ai_scope_stmt;
...
('director_ai_cs', 'e10adc3949ba59abbe56e057f20f883e', 'director', '周启明', NULL, 'ai', 'cs', NULL, '人工智能学部', 'director_ai_cs@school.edu', '13800000011', 1),
('director_ai_se', 'e10adc3949ba59abbe56e057f20f883e', 'director', '宋嘉树', NULL, 'ai', 'se', NULL, '人工智能学部', 'director_ai_se@school.edu', '13800000012', 1),
('director_ai_ds', 'e10adc3949ba59abbe56e057f20f883e', 'director', '邵文澜', NULL, 'ai', 'ds', NULL, '人工智能学部', 'director_ai_ds@school.edu', '13800000013', 1),
('director_ai_ai', 'e10adc3949ba59abbe56e057f20f883e', 'director', '韩知远', NULL, 'ai', 'ai', NULL, '人工智能学部', 'director_ai_ai@school.edu', '13800000014', 1)
