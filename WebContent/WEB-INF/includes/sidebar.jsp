...
<div class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <% if ("admin".equals(userRole)) { %>
      <a href="<%= ctx %>/admin/users.jsp" class="<%= sidebarCurrentPage.contains("/admin/users") ? "active" : "" %>">&#9632; 用户管理</a>
    ...
    <% } else if ("teacher".equals(userRole)) { %>
      <a href="<%= ctx %>/teacher/topics.jsp" class="<%= sidebarCurrentPage.contains("/teacher/topics") ? "active" : "" %>">&#9632; 我的课题</a>
      <a href="<%= ctx %>/teacher/selections.jsp" class="<%= sidebarCurrentPage.contains("/teacher/selections") ? "active" : "" %>">&#9632; 选题审批</a>
      <a href="<%= ctx %>/teacher/documents.jsp" class="<%= sidebarCurrentPage.contains("/teacher/documents") ? "active" : "" %>">&#9632; 文档审核</a>
    ...
    <% } else { %>
      <a href="<%= ctx %>/student/topics.jsp" class="<%= sidebarCurrentPage.contains("/student/topics") ? "active" : "" %>">&#9632; 浏览课题</a>
      <a href="<%= ctx %>/student/my-selection.jsp" class="<%= sidebarCurrentPage.contains("/student/my-selection") ? "active" : "" %>">&#9632; 我的选题</a>
      <a href="<%= ctx %>/student/documents.jsp" class="<%= sidebarCurrentPage.contains("/student/documents") ? "active" : "" %>">&#9632; 文档提交</a>
