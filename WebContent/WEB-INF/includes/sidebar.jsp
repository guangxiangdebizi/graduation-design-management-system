...
<%
  ...
  Integer unreadMsgObj = (Integer) request.getAttribute("unreadMsg");
  int unreadMsg = unreadMsgObj == null ? 0 : unreadMsgObj.intValue();
%>
<div class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    <a href="<%= ctx %>/dashboard.action" class="<%= sidebarCurrentPage.contains("/dashboard") ? "active" : "" %>">&#9632; 仪表盘</a>
    <% if ("admin".equals(userRole)) { %>
      ...
      <a href="<%= ctx %>/admin/messages.action" class="<%= sidebarCurrentPage.contains("/messages") ? "active" : "" %>">&#9632; 站内消息<% if (unreadMsg > 0) { %> <span class="badge bg-danger"><%= unreadMsg %></span><% } %></a>
    ...
    <% } else { %>
      ...
      <a href="<%= ctx %>/student/defense.action" class="<%= sidebarCurrentPage.contains("/student/defense") ? "active" : "" %>">&#9632; 我的答辩</a>
      ...
      <a href="<%= ctx %>/student/messages.action" class="<%= sidebarCurrentPage.contains("/messages") ? "active" : "" %>">&#9632; 站内消息<% if (unreadMsg > 0) { %> <span class="badge bg-danger"><%= unreadMsg %></span><% } %></a>
    <% } %>
