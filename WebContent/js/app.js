...
function initPageMessages() {
  ...
  var errorKeys = ['error', 'quota_full', 'import_empty', 'import_error', 'csrf_error',
    ...
    'defense_student_invalid', 'defense_teacher_count',
  ...
  var messages = {
    ...
    'defense_student_invalid': '该学生不在当前专业范围，或终稿尚未通过',
    'defense_teacher_count': '必须选择三名答辩教师',
    'defense_teacher_duplicate': '三名答辩教师不能重复',
    'defense_teacher_scope': '只能选择当前专业的有效教师',
    'defense_not_member': '您不是该学生的答辩教师，不能评分',
