...
<div class="content-card">
  <h5>完整版功能预告</h5>
  <p class="text-muted">答辩安排、成绩导出 Excel、ECharts 统计图表、站内消息等功能将在完整版中开放。</p>
</div>
  ...
  <div class="col-md-6">
    <div class="content-card">
      ...
      <% for (int i=0; i<Math.min(3, announcements.size()); i++) {
        ...
        <div class="announce-item">
          <div class="title"><%= a.getTitle() %></div>
          <div class="content"><%= a.getContent().length()>80 ? a.getContent().substring(0,80)+"..." : a.getContent() %></div>
        </div>
      <% } %>
    </div>
  </div>
